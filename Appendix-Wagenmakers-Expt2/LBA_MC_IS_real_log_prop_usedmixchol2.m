function [llh,var_llh]=LBA_MC_IS_real_log_prop_usedmixchol2(data,param,...
num_subjects,num_trials,num_particles,mean_theta,covmat_theta)
var_llh_opt=1;
var_llh_opt_i=var_llh_opt/num_subjects;
num_particles_inc=250;
parfor j=1:num_subjects
    ...
    [rnorm_theta_b_kron]=reshape_b(data_cond_repmat,data_actualresp_repmat,rnorm_theta_b11_kron,rnorm_theta_b12_kron,rnorm_theta_b21_kron,rnorm_theta_b22_kron);
