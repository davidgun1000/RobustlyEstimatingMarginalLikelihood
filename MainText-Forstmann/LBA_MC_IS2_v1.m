...
parfor j=1:num_subjects
    ...
    xx=[param.theta_mu';chol_theta_sig2_1';chol_theta_sig2_2';chol_theta_sig2_3';...
        chol_theta_sig2_4';chol_theta_sig2_5';chol_theta_sig2_6';chol_theta_sig2_7']; % we need this to compute the mean of the proposal of the random effects
    cond_mean=mean_theta(j,1:num_randeffect)'+covmat_theta(1:num_randeffect,num_randeffect+1:end,j)*((covmat_theta(num_randeffect+1:end,num_randeffect+1:end,j))\(xx-mean_theta(j,num_randeffect+1:end)')); % computing the mean of the proposal of random effect
    cond_var=covmat_theta(1:num_randeffect,1:num_randeffect,j)-covmat_theta(1:num_randeffect,num_randeffect+1:end,j)*(covmat_theta(num_randeffect+1:end,num_randeffect+1:end,j)\covmat_theta(num_randeffect+1:end,1:num_randeffect,j)); %computing the covariance matrix of the proposal of the random effect
